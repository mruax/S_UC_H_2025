# Generated by Django 4.2.7 on 2025-11-20 14:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trajectory_type', models.CharField(choices=[('personal', 'Личная траектория'), ('teacher', 'Траектория преподавателя')], max_length=20)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='trajectories', to=settings.AUTH_USER_MODEL)),
                ('teacher', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='assigned_trajectories', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trajectory', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='courses', to='core.trajectory')),
            ],
            options={
